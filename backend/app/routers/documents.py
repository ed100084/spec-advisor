...
async def upload_document(
    ...
    confidentiality_level: str = Form("中"),
    integrity_level: str = Form("中"),
    availability_level: str = Form("中"),
    legal_compliance_level: str = Form("中"),
    ...
    doc = Document(
        ...
        project=project,
        is_information_system=is_information_system,
        applies_system_introduction_grading=applies_system_introduction_grading,
