...
class Document(Base):
    ...
    is_information_system: Mapped[bool] = mapped_column(default=True)
    applies_system_introduction_grading: Mapped[bool] = mapped_column(default=True)
    is_critical_infrastructure: Mapped[bool] = mapped_column(default=True)
    organization_category: Mapped[str] = mapped_column(String(50), default="特定非公務機關")
    security_responsibility_level: Mapped[str] = mapped_column(String(1), default="A")
    confidentiality_level: Mapped[str] = mapped_column(String(1), default="中")
    integrity_level: Mapped[str] = mapped_column(String(1), default="中")
    availability_level: Mapped[str] = mapped_column(String(1), default="中")
    legal_compliance_level: Mapped[str] = mapped_column(String(1), default="中")
    protection_level: Mapped[str] = mapped_column(String(1), default="中")
