...
export const uploadDocument = (file, department = '', project = '', securityMeta = {}) => {
  ...
  form.append('applies_system_introduction_grading', securityMeta.appliesSystemIntroductionGrading ?? true)
  form.append('is_critical_infrastructure', securityMeta.isCriticalInfrastructure ?? true)
  form.append('organization_category', securityMeta.organizationCategory || '特定非公務機關')
  form.append('security_responsibility_level', securityMeta.securityResponsibilityLevel || 'A')
  form.append('confidentiality_level', securityMeta.confidentialityLevel || '中')
  form.append('integrity_level', securityMeta.integrityLevel || '中')
  form.append('availability_level', securityMeta.availabilityLevel || '中')
  form.append('legal_compliance_level', securityMeta.legalComplianceLevel || '中')
